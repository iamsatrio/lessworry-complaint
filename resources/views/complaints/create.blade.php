...
<div class="card">
  ...
  <select id="ch" name="channel" required>
    {{-- Kanal disimpulkan dari peran pembuka form (User::defaultChannel).
         Untuk peran yang kanalnya tidak bisa disimpulkan, tidak ada yang
         terpilih — sama seperti kategori, bobot, dan layanan. --}}
